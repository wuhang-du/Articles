...
"use strict";
var t=e("biz_wap/jsapi/core.js"),n=e("biz_common/dom/event.js"),o=e("biz_wap/utils/mmversion.js"),i=e("pages/bottom_input_bar.js"),s=e("common/utils.js"),c=o.getInner(),r=!1,l=!1,u=!1;
o.isIOS&&o.gtVersion("7.0.16")?(r=!0,l=!0,u=!0):o.isAndroid&&(o.gtVersion("7.0.18")&&"27001634">c||c>="28000038")&&(r=!0,
l=c>="27001700");
var a=[],f=null,d=!1,p=null,y=null,h=null;
r&&(t.on("onGetKeyboardHeight",function(e){
a.length&&a.forEach(function(t){
"function"==typeof t&&t(e.height);
});
}),l&&(f=document.createElement("div"),f.style.cssText="width: 100%; height: 100%; position: fixed; top: 0; background-color: transparent; z-index: 99999999; display: none;",
...
var m=function(){
return r?!0:(console.log("Not support keyboard."),!1);
};
return{
canUseKeyboard:r,
canUseCancel:l,
onGetKeyboardHeight:function(e){
m()&&-1===a.indexOf(e)&&a.push(e);
},
...
if(y=e.cancel,h=e.hide,u||e.forceFallback){
var n=function(){
p||(p=new i);
var t=!1;
