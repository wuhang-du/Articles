...
t&&(e||(E.rewardLink&&m.off(E.rewardLink,"click",C),E.authorAvatarLink&&m.off(E.authorAvatarLink,"click",O),
H=[],o({
...
return function(t){
if("link"===n&&T.is_teenager)return void weui.alert("青少年模式下不可赞赏");
...
i(),d=setInterval(i,12e4),n.classList[E.rewardLink.getBoundingClientRect().top<222?"add":"remove"]("reward_pop_bottom"),
n.classList.add(t);
var a=function r(a){
...
}else"avatar"===n&&window.__addIdKeyReport?window.__addIdKeyReport(T.likeHeadId,T.likeHeadKey):window.__addIdKeyReport&&window.__addIdKeyReport(T.likeBtnId,T.likeBtnKey),
...
if(C=s(o,x,"link"),O=s(o,x,"avatar"),m.on(u,"click",C),T.author_id&&1==e.can_reward&&v&&m.on(v,"click",O),
...
},C=function(){},O=function(){},P=document.getElementById("js_author_reward_qrcode_img"),N=function(){
