...
N||(!_.isAndroid||window.topbarInited)&&(O(0),N=!0);
...
if(window.is_teenager)return window.weui.alert("青少年模式下不可付费"),void(g=!1);
...
return U&&(v||b)&&(window.__addIdKeyReport("28307",106),o=rt.addParam(o,"tp","wxpic",!0),
o=U+"hevc?url="+encodeURIComponent(o)+"&type="+o.getOriginImgType()),"anonymous"==e.crossOrigin&&(o=rt.addParam(o,"wx_co","1",!0)),
...
if(-1!=B){
if(console.log("[横屏滚动检测]",a-B),500>a-B)return void(B=-1);
}else B=-1;
...
var Et=Math.random();
if(2e-4>Et)try{
for(var kt=document.getElementsByTagName("img"),zt=window.screen.height,Bt=window.screen.width,Pt=0,St=window.devicePixelRatio,Pt="",F=0,Tt=kt.length;Tt>F;F++){
var Rt=kt[F].getAttribute("data-src");
if(Rt){
var Ct=kt[F].getBoundingClientRect();
Pt+=Bt+"|"+zt+"|"+Ct.left.toFixed(2)+"|"+(Bt-Ct.right).toFixed(2)+"|"+Ct.width.toFixed(2)+"|"+St.toFixed(2)+"|"+Rt+";";
}
}
l({
...
e("appmsg/popup_report.js")),k=e("appmsg/pay_report_utils.js"),z=e("appmsg/loading.js"),B=-1,P=e("appmsg/finance_communicate.js"),S=e("appmsg/topbar.js"),T=e("biz_wap/utils/jsmonitor_report.js"),R=e("appmsg/getForbidConfig.js"),C=e("appmsg/set_article_read.js"),O=C.setArticleRead,N=!1;
